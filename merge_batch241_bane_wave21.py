...
NEW_RULES = [
    ...
    },
    {
        ...
        "statement": (
            ...
            "garrison assault, MCD-432; the multi-day siege, MCD-529; the vertical battlement fight, "
            "MCD-703; the precision-constrained bridge defense, MCD-1026; and the most-intense ravine "
            "battle, MCD-709) by its continuous-motion constraint, requiring all three Trinity "
