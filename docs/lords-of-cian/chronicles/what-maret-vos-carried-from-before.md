# What Maret Vos Carried From Before

*Locked canon, Batch 182, 2026-09-11 (`MCD-533`). Trench Monarch Alias Chronicle XV, closing the
fifth wave. Rebellion era, age 18, before the Black Trench. Not a territory Chronicle. New
standalone material. Narrated in neutral third-person prose. No new named characters beyond the
already-locked Maret Vos.*
...
"You never talk about before," she said. "Halst tells stories. Sok's told one, I heard. You've never
said a word."
...
plainly, without ornament, exactly the way Maret Vos himself had always carried it.

---

*Continuity notes (not narrative): closes a trilogy of early-crew perspectives alongside Corren
Halst's retrospective (`MCD-436`) and Danne Sok's shared memory (`MCD-530`) — Maret Vos's own account,
the quietest and least dramatized of the three, deliberately resists narrative embellishment rather
than matching either prior entry's register. No new named characters beyond the already-locked Maret
Vos. Closes the Trench Monarch's fifth three-Chronicle wave (with "The Table Across from the Owners,"
